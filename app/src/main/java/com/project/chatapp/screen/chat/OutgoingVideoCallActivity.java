...
public class OutgoingVideoCallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callStatusText.setText("Đang gọi video...");
        // Lấy tên đối phương
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.child("status").exists()) {
                    ...
                    if ("accepted".equals(status)) {
                        // Sang màn hình gọi video thật sự
                        Intent intent = new Intent(OutgoingVideoCallActivity.this, VideoCallActivity.class);
                        ...
                        Toast.makeText(OutgoingVideoCallActivity.this, "Đối phương đã từ chối cuộc gọi", Toast.LENGTH_SHORT).show();
                        finishToChat();
                    }
                }
            }
